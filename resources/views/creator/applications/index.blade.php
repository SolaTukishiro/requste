            ...
            <div class="application-index__grid">
                    ...
                    <a href="{{route('creator.applications.detail', $application)}}" class ="application-index__card">
                        <div class="application-index__card-header">
                            ...
                            @if($application->status)
                                <span class="application-index__badge is-open">募集中</span>
                            @else
                                <span class="application-index__badge is-closed">募集終了中</span>
                            @endif
                        </div>
                ...
                @empty
                    <div class="application-index__empty">
                        <p class="application-index__empty-title">作成した案件はまだありません。</p>
                    </div>
                @endforelse
            </div>
        </div>
