    ...
    <div class="request-detail">
        <div class="request-detail__card">
            ...
            <div class="request-detail__actions">
                <a class="request-detail__button is-ghost" href="{{ route('creator.applications.index') }}">
                    一覧へ戻る
                </a>
                <a class="request-detail__button is-primary" href="{{ route('creator.applications.edit', $application) }}">
                    修正する
                </a>
            </div>
        </div>
